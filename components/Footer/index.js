    ...
    <footer className={style.footer}>
      <div className={style.container}>
        <div className={style.firstColllum}>
          ...
          <h4>ESTÁS SOB ATAQUE ?</h4>
          <p>report@athsec.org</p>
        </div>
        ...
        <div className={style.secondColllum}>
          ...
          <div className={style.links}>
            <Link href="/enterprise">Cyber Defense Enterprise</Link>
            <Link href="/security-testing">Vulnerability Asessments & Penetration Testing</Link>
            <Link href="/mdr">Managed Detection & Response</Link>
          </div>
        </div>
        ...
        <div className={style.colllum}>
          ...
          <div className={style.links}>
            <Link href="https://t.me/athsec_community">Community</Link>
            <Link href="http://athsecacademy.medium.com/">Blog</Link>
          </div>
        </div>
